 ...
 */
public class GUIConectarAdmin extends JFrame {
    ...
    public GUIConectarAdmin() {
        ...
        String informacion = " La siguiente aplicación le permitira ingresar como \n"
                + " Administrador, y le permitira ver la informacion  de  \n"
                + " las Facturas generadas de los pedidos.";
        ...
        etiquetaTitulo = new JLabel("Admin", SwingConstants.CENTER);
        etiquetaTitulo.setToolTipText("Titulo");
        etiquetaTitulo.setBorder(BorderFactory.createLineBorder(Color.GREEN, 3));
        etiquetaTitulo.setFont(new Font("Tahoma", Font.BOLD + Font.ITALIC, 45));
        ...
        esquemaGridLayout = new GridLayout(2, 2, 5, 5);
        ...
        if(camposValidos == 2) {
            ...
            if(objRemotoServidor != null) {
                ...
                if(seObtuvoObjRemoto) {
                    GUIAdministrador vistaAdministrador = new GUIAdministrador(objRemotoServidor);
                    vistaAdministrador.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
                    vistaAdministrador.setSize(700, 550);
